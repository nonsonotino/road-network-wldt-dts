    ...
    public static void main(final String[] args) {
        try {
            ...
            final DigitalTwin prDT = new DigitalTwin(prDTId,
                    new MirrorShadowingFunction("pr-shadowing-function"));
            ...
            */
            ...
            MqttPhysicalAdapterConfiguration ptPhysicalAdapterConfiguration = MqttPhysicalAdapterConfiguration.builder("localhost", 1883)
                    .addPhysicalAssetEventAndTopic("car-detected", " ", "plateReader1/events/car_detected", PlateReaderRecord.extractFromJSONFunction())
                    .build();
